...
public interface MessageReceiver {
     ...
     * @throws IOException throws Exception if Message couldnt be readed
     * @throws InterruptedException if message couldnt be parsed
     */
    void onMessageReceived(String route, String replyTo, String message,
